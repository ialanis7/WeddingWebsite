const translations = {
    ...
    en: {
      ...
      faq: {
        ...
        parkingAnswer: "Yes, there is free parking available at the venue. Please wait in your car at the front gate until the security guard opens it. Parking for all event guests is in the public parking lot next to the Museum. Valet-Parking is allowed.",
    ...
    es: {
      ...
      faq: {
        ...
        parkingAnswer: "Sí, hay estacionamiento gratuito disponible en el lugar. Por favor, espere en su coche en la entrada principal hasta que el guardia de seguridad la abra. El estacionamiento para todos los invitados del evento está en el lote público al lado del museo. Se permite servicio de valet.",
